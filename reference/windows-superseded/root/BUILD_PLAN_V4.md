...
- **"harness" is overloaded** — Eve's eve-session-loop nests *inside* QuantFlow's
...
> layer: persist `task↔eveSessionId`, drive Eve cancel/recover via its API, consume
