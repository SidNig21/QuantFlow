...
**Stale — do NOT follow:** `ARCHITECTURE.md` (now archived under `reference/v3-superseded/`), `BUILD_PLAN_V2.md`, `BUILD_PLAN_V3.md`, and any v2/v3 *execution* doc. The v3 glossary is the live vocabulary base (formal v4 promotion pending).
