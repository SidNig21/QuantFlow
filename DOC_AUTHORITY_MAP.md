...
| `reference/v7-superseded/**` (`V7_MISSION.md`, `V7-0-FOUNDER-DECISIONS.md`) | Old v7 mission order + dated founder-decisions record. **Superseded 2026-07-09** by `docs/v7/DOCK_RUNTIME_REWORK_SPEC.md`. History only. |
